...
DROP TABLE IF EXISTS SURVEY.SURVEY_SECTION_DEFINITIONS CASCADE;
...
CREATE TABLE SURVEY.SURVEY_SECTION_DEFINITIONS (
  ID                         UUID NOT NULL,
  VERSION                    INTEGER NOT NULL,
  ...
  DESCRIPTION                TEXT NOT NULL,
	...
	PRIMARY KEY (ID, VERSION),
	CONSTRAINT  SURVEY_SURVEY_SECTION_DEFINITIONS_SURVEY_DEFINITION_FK FOREIGN KEY (SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION) REFERENCES SURVEY.SURVEY_DEFINITIONS(ID, VERSION) ON DELETE CASCADE
);

CREATE INDEX SURVEY_SURVEY_SECTION_DEFINITIONS_SURVEY_DEFINITION_IX
  ON SURVEY.SURVEY_SECTION_DEFINITIONS
  (SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION);

COMMENT ON COLUMN SURVEY.SURVEY_SECTION_DEFINITIONS.ID
  IS 'The Universally Unique Identifier (UUID) used, along with the version of the survey section definition, to uniquely identify the survey section definition';  

COMMENT ON COLUMN SURVEY.SURVEY_SECTION_DEFINITIONS.VERSION
  IS 'The version of the survey section definition';  

COMMENT ON COLUMN SURVEY.SURVEY_SECTION_DEFINITIONS.SURVEY_DEFINITION_ID
  IS 'The Universally Unique Identifier (UUID) used, along with the version of the survey definition, to uniquely identify the survey definition this survey section definition is associated with';  

COMMENT ON COLUMN SURVEY.SURVEY_SECTION_DEFINITIONS.SURVEY_DEFINITION_VERSION
  IS 'The version of the survey definition this survey section definition is associated with';  

COMMENT ON COLUMN SURVEY.SURVEY_SECTION_DEFINITIONS.INDEX
  IS 'The index used to define the order of the survey section definitions for a survey definition';  

COMMENT ON COLUMN SURVEY.SURVEY_SECTION_DEFINITIONS.NAME
  IS 'The name of the survey section definition';  

COMMENT ON COLUMN SURVEY.SURVEY_SECTION_DEFINITIONS.DESCRIPTION
  IS 'The description for the survey section definition';  
...
CREATE TABLE SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (
  ...
  SURVEY_DEFINITION_ID               UUID NOT NULL,
  SURVEY_DEFINITION_VERSION          INTEGER NOT NULL,
  SURVEY_SECTION_DEFINITION_ID       UUID,
  SURVEY_SECTION_DEFINITION_VERSION  INTEGER,
  INDEX                              INTEGER NOT NULL,
  NAME                               TEXT NOT NULL,
  SURVEY_GROUP_DEFINITION_ID         UUID NOT NULL,
  SURVEY_GROUP_DEFINITION_VERSION    INTEGER NOT NULL,
  RATING_TYPE                        INTEGER NOT NULL,
	...
	CONSTRAINT  SURVEY_SURVEY_GROUP_RATING_ITEM_DEFINITIONS_SURVEY_SECTION_DEFINITION_FK FOREIGN KEY (SURVEY_SECTION_DEFINITION_ID, SURVEY_SECTION_DEFINITION_VERSION) REFERENCES SURVEY.SURVEY_SECTION_DEFINITIONS(ID, VERSION) ON DELETE CASCADE,
...
CREATE INDEX SURVEY_SURVEY_GROUP_RATING_ITEM_DEFINITIONS_SURVEY_SECTION_DEFINITION_IX
  ON SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS
  (SURVEY_SECTION_DEFINITION_ID, SURVEY_SECTION_DEFINITION_VERSION);
...
COMMENT ON COLUMN SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS.SURVEY_SECTION_DEFINITION_ID
  IS 'The Universally Unique Identifier (UUID) used, along with the version of the survey section definition, to uniquely identify the optional survey section definition this survey group rating item definition is associated with';

COMMENT ON COLUMN SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS.SURVEY_SECTION_DEFINITION_VERSION
  IS 'The version of the optional survey section definition this survey group rating item definition is associated with';

COMMENT ON COLUMN SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS.INDEX
  IS 'The index used to define the order of the items under the survey definition or survey section definition this survey group rating item definition is associated with';  
...
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c34543f0-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 1, 'Accountability', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c345462a-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 2, 'Competence', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c34549f4-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 3, 'Courage', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c3454b7a-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 4, 'Fairness', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c3454c6a-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 5, 'Integrity', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c3454d3c-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 6, 'Openness', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c3454e04-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 7, 'Positive Attitude', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c3454ec2-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 8, 'Teamwork', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c3454f8a-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 9, 'Making a Difference', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
INSERT INTO SURVEY.SURVEY_GROUP_RATING_ITEM_DEFINITIONS (ID, VERSION, SURVEY_DEFINITION_ID, SURVEY_DEFINITION_VERSION, INDEX, NAME, SURVEY_GROUP_DEFINITION_ID, SURVEY_GROUP_DEFINITION_VERSION, RATING_TYPE) VALUES
  ('c345523c-8ba9-11e6-ae22-56b6b6499611', 1, '706fb4a4-8ba8-11e6-ae22-56b6b6499611', 1, 10, 'Trust', '98886698-8ba8-11e6-ae22-56b6b6499611', 1, 2);
...
GRANT ALL ON TABLE SURVEY.SURVEY_SECTION_DEFINITIONS TO survey;
