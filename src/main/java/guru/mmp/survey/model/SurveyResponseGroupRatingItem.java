...
//
//  /**
//   * The survey group definition member this survey response group rating item is associated with.
//   */
...
//
//  /**
//   * Returns the survey group definition member this survey response group rating item is associated
//   * with.
//   *
//   * @return the survey group definition member this survey response group rating item is associated
//   *         with
//   */
...
//
//  /**
//   * Set the survey group definition member this survey response group rating item is associated with.
//   *
//   * @param templateGroupMemberId the survey group definition member this survey response group rating
...
//
//  /**
//   * Set the Universally Unique Identifier (UUID) used to uniquely identify the survey definition
//   * group rating item this survey response group rating item is associated with.
//   *
//   * @param templateItemId the Universally Unique Identifier (UUID) used to uniquely identify the
//   *                       survey group rating item definition this survey response group rating
//   *                       item is associated with
//   */
